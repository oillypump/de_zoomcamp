    ...
    def merge_target(local_file_path: str, table_name: str, color: str):
        ...
        query_merge = f"""
            ...
            WHEN NOT MATCHED THEN
                INSERT (unique_id, file_name, vendor_id, lpep_pickup_datetime, lpep_dropoff_datetime, store_and_fwd_flag, ratecode_id, pu_location_id, do_location_id, passenger_count, trip_distance, fare_amount, extra, mta_tax, tip_amount, tolls_amount, ehail_fee, improvement_surcharge, total_amount, payment_type, trip_type, congestion_surcharge, cbd_congestion_fee)
                VALUES (S.unique_id, S.file_name, S.vendor_id, S.lpep_pickup_datetime, S.lpep_dropoff_datetime, S.store_and_fwd_flag, S.ratecode_id, S.pu_location_id, S.do_location_id, S.passenger_count, S.trip_distance, S.fare_amount, S.extra, S.mta_tax, S.tip_amount, S.tolls_amount, S.ehail_fee, S.improvement_surcharge, S.total_amount,S.payment_type,S.trip_type,S.congestion_surcharge,S.cbd_congestion_fee);
        """
